...
if __name__ == "__main__":
    """
    d = DistributedTraining('randominitreward',{'num_games' : [15000],'random_init': [True,False],'reward':['building','victory_only'],
                                             ...
                                             """
    train = TrainCatan(random_shuffle_training_players=True)
